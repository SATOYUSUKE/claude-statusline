...
```bash
curl -fsSL https://raw.githubusercontent.com/ysato/claude-statusline/main/install.sh | bash
```
...
```bash
# スクリプトをダウンロード
curl -fsSL https://raw.githubusercontent.com/ysato/claude-statusline/main/statusline.sh \
...
- 各指標の整理・改善: [@ysato](https://github.com/ysato)
